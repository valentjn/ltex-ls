...
public class NopFragmentizerTest {
  @Test
  public void test() {
    CodeFragmentizer fragmentizer = CodeFragmentizer.create("nop");
    ...
    Assertions.assertEquals("nop", codeFragments.get(0).getCodeLanguageId());
