...
public class AnnotatedTextBuilder {
  ...
  private static final CommandSignature[] defaultCommandSignatures = {
    ...
    new CommandSignature("\\algnewcommand{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\algrenewcommand{}", CommandSignature.Action.IGNORE),
    ...
    new CommandSignature("\\Cref{}", CommandSignature.Action.DUMMY),
    new CommandSignature("\\crefname{}{}{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\DeclareMathOperator{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\definecolor{}{}{}", CommandSignature.Action.IGNORE),
    ...
    new CommandSignature("\\graphicspath{}", CommandSignature.Action.IGNORE),
    ...
    new CommandSignature("\\newcommand{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\newcommand[]{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\newcommand*{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\newcommand*[]{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\newcounter{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\raisebox{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\ref{}", CommandSignature.Action.DUMMY),
    new CommandSignature("\\ref*{}", CommandSignature.Action.DUMMY),
    new CommandSignature("\\renewcommand{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\renewcommand[]{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\renewcommand*{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\renewcommand*[]{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\textcolor{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\tikzset{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\sisetup{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\todo{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\todo[]{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\usetikzlibrary{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\usepackage{}", CommandSignature.Action.IGNORE),
    new CommandSignature("\\usepackage[]{}", CommandSignature.Action.IGNORE),
