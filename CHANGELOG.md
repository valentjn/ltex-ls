...
- Add non-server batch mode via `--input-documents` (fixes [#71](https://github.com/valentjn/ltex-ls/issues/71))
...
- Fix diagnostics contain markup before actual error (fixes [vscode-ltex#349](https://github.com/valentjn/vscode-ltex/issues/349))
...
- Fix LT<sub>E</sub>X LS not terminating if input stream is end-of-file (fixes [vscode-ltex#325](https://github.com/valentjn/vscode-ltex/issues/325))
...
- Add support for special characters in L<sup>A</sup>T<sub>E</sub>X: `\L` (&#x0141;), `\SS` (&#x1e9e;), `\i` (&#x0131;), `\j` (&#x0237;), and `\l` (&#x0142;) ([PR #57](https://github.com/valentjn/ltex-ls/pull/57) by [@ed359](https://github.com/ed359), fixes [#56](https://github.com/valentjn/ltex-ls/issues/56))
